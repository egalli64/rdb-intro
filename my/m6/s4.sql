/*
    ...
    Examples on transaction anomalies -- see s4T2.sql for the other transaction code
 */
use hron;
...
-- (3) T2 update the row
-- update service set name = 'T2 update' where service_id = 22;
...
-- update service set name = concat(name, 'Z') where service_id = 22;
...
-- (2) T2
-- update service set name = 'dirty' where service_id = 22;
